...
function getMode(isKnown, isBlack) {
    const mode = isBlack
        ? isKnown
...
// Parse game
function parseGameV128(binary, createBuilder) {
...
function parseGameV002(binary, createBuilder) {
...
export function createGame(base64urlEncodedGameCode, createBuilder) {
